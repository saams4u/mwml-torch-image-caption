...
class DecoderWithAttention(nn.Module):
	...
	def __init__(self, attention_dim, embed_dim, decoder_dim, vocab_size, encoder_dim=2048, dropout=0.5):
		...
		self.init_c = nn.Linear(encoder_dim, decoder_dim)  # linear lyaer to find initial cell state of LSTMCell
	...
	def forward(self, encoder_out, encoded_captions, caption_lengths):
		...
		# We won't decode at the <end> position, since we're finished generating as soon as we generate <end>
